...
class ChatBot:
    ...
    def __init__(self):
        ...
        self.model_name = os.getenv("MODEL_NAME", "minimax/minimax-m2:free")
    ...
    def add_message(self, role: str, content: str):
        ...
        # + системный промпт (если он был добавлен)
        max_messages = 10
        if len(self.conversation_history) > max_messages + 1:  # +1 для system промпта
